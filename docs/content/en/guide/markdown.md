...
Please make sure you are using the latest version of the theme and [Hugo v0.146.0](https://github.com/gohugoio/hugo/releases/tag/v0.146.0) or later.
...
Below is the default configuration for the theme:
