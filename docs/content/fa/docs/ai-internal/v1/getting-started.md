...
دو روش اصلی برای افزودن تم به پروژه Hugo شما وجود دارد:
...
2. **زیرماژول Git**: به عنوان جایگزین، تم را به عنوان یک [زیرماژول Git](https://git-scm.com/book/en/v2/Git-Tools-Submodules) اضافه کنید. تم توسط Git دانلود شده و در پوشه `themes` پروژه شما ذخیره می‌شود.

### راه‌اندازی تم به عنوان ماژول Hugo
...
### راه‌اندازی تم به عنوان زیرماژول Git
...
### افزودن تم به عنوان زیرماژول Git
...
عدم اجرای این دستور منجر به پر نشدن پوشه تم با فایل‌های تم شده و باعث شکست ساخت می‌شود.
...
برای به‌روزرسانی تم به آخرین کامیت، دستور زیر را اجرا کنید:
