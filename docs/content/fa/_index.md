...
<div class="hx:mb-6">
{{< theme/hero-button text="شروع کنید" link="docs" >}}
</div>
...
{{< theme/feature-grid >}}
  ...
  {{< theme/feature-card
    ...
    image="/images/feature-markdown.webp"
  ...
  {{< theme/feature-card
    ...
    class="hx:aspect-auto hx:md:aspect-[1.1/1] hx:max-md:min-h-[340px]"
    image="/images/feature-search.webp"
    imageClass="hx:top-[40%] hx:left-[36px] hx:w-[110%] hx:sm:w-[110%] hx:dark:opacity-80"
    style="background: radial-gradient(ellipse at 50% 80%,rgba(221,210,59,0.15),hsla(0,0%,100%,0));"
  >}}
  {{< theme/feature-card
    title="سبک مانند یک پر"
    subtitle="به هیچ وابستگی یا Node.js نیاز نیست. با پشتیبانی از هیوگو، یکی از سریع‌ترین تولیدکنندگان سایت استاتیک، سایت شما را تنها در چند ثانیه با یک باینری می‌سازد."
  >}}
  {{< theme/feature-card
